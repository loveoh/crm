        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="newForm">
                    ...
                    <div class="form-group">
                        <label>关联客户</label>
                        <select name="custmoerid" class="form-control">
    ...
    $(function () {
        ...
        var table = $("#dataTable").DataTable({
            ...
            ajax:{
                ...
                data:function (datasource) {
                    datasource.startTime = $("#search_start_time").val();
                    datasource.endTime = $("#search_end_time").val();
            ...
            columns:[
               ...
               {"data":function (row) {
                   return " <a href='/customerManagement/" + row.custmoerid + "'>" + row.custname + "</a>";
               }},
               {"data":function (row) {
                   return "￥" + row.price;
               }},
        ...
        $("#newForm").validate({
            ...
            submitHandler:function () {
                $.post("/sales/new",$("#newForm").serialize()).done(function (data) {
                    if (data == "success"){
                        $("#newModal").modal('hide');
                        table.ajax.reload();
                    }
